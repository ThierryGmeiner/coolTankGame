...
//     version 1.3.0
//     from Assets/Scripts/Game/Entity/Objects/Tank/Player/PlayerControler.inputactions
//
...
namespace Game.InputSystem
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""AddPath"",
                    ""type"": ""Button"",
                    ""id"": ""474e8612-a0e2-4734-a434-ed69b832362e"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""07f2de4c-a5b7-4692-8ff5-e2abbd2c7c2e"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
            ...
            m_TankDrive_AddPath = m_TankDrive.FindAction("AddPath", throwIfNotFound: true);
            // TankAttack
        ...
        private readonly InputAction m_TankDrive_AddPath;
        public struct TankDriveActions
        {
            ...
            public InputAction @AddPath => m_Wrapper.m_TankDrive_AddPath;
            ...
            public void SetCallbacks(ITankDriveActions instance)
            {
                if (m_Wrapper.m_TankDriveActionsCallbackInterface != null)
                {
                    ...
                    @AddPath.started -= m_Wrapper.m_TankDriveActionsCallbackInterface.OnAddPath;
                    @AddPath.performed -= m_Wrapper.m_TankDriveActionsCallbackInterface.OnAddPath;
                    @AddPath.canceled -= m_Wrapper.m_TankDriveActionsCallbackInterface.OnAddPath;
                }
                ...
                if (instance != null)
                {
                    ...
                    @AddPath.started += instance.OnAddPath;
                    @AddPath.performed += instance.OnAddPath;
                    @AddPath.canceled += instance.OnAddPath;
                }
            }
        }
        ...
        public interface ITankDriveActions
        {
            ...
            void OnAddPath(InputAction.CallbackContext context);
        }
